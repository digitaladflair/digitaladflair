...
export const caseStudiesSalem = {
  ...
  items: [
    ...
    },
    {
      ...
      results: '480+ leads in 3 months, 37% conversion increase, 4X ROI'
    }
  ]
};
...
export const packagesSalem = {
  ...
  plans: [
    ...
    { name: 'Growth', ideal: 'Startups, SMEs', price: '₹19,999/month', services: 'Full SEO, PPC, SMM, Email' },
    { name: 'Pro', ideal: 'Ecommerce, Agencies', price: '₹34,999/month', services: 'All Channels, Lead Gen' }
  ]
};
...
export const faqsSalem = {
  ...
  items: [
    ...
    { question: 'What makes you better than other agencies?', answer: 'Local expertise, E-E-A-T focus, transparent ROI.' }
  ]
};
...
export const contactSalem = {
  ...
  phone: '+91XXXXXXXXXX',
  email: 'hello@digitaladflair.com'
};